 ...
 *
 * Os serviços são gerenciados diretamente pelo editor desta página.
 * Use blocos Gutenberg ou o editor clássico para adicionar/editar o conteúdo.
 */
get_header();
...
<!-- CONTEÚDO DA PÁGINA (editado pelo admin) -->
